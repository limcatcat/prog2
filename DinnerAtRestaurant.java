...
public class DinnerAtRestaurant {
	...
	public static void main(String[] args) {
		...
		if(peter.isHungry()==true) {
			...
			tina.makeOrder(john, MenuItem.values()[peter.getOrderID()],peter.getOrderID());
			peter.waitingForFood();

			Dish servedDish = tina.serveDish(MenuItem.values()[ peter.getOrderID()-1],peter.getCustomerID());
